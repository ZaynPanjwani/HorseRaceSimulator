    ...
    public void startRace()
    {
        ...
        while (!finished)
        {
            ...
            if (raceWonBy(lane1Horse) || raceWonBy(lane2Horse) || raceWonBy(lane3Horse) || (lane1Horse.hasFallen() && lane2Horse.hasFallen() && lane3Horse.hasFallen())) {
                finished = true;
                if (raceWonBy(lane1Horse) && (!lane1Horse.hasFallen())) {
                ...
                } else if (raceWonBy(lane2Horse) && (!lane2Horse.hasFallen())) {
                    ...
                    System.out.println("There is no winner as all the horses have fallen");
                }
